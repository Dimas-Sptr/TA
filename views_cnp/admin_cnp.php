                                                        ...
                                                        <form class="user" method="POST" action="proses_editCNP.php" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col-lg-6">
                                                                    ...
                                                                    <input type="text" class="form-control " name="email" placeholder="Ketik Email C&P ..." value="<?php echo $d['email']; ?>">
                                                                </div>
                                                            ...
                                                            <div class="modal-footer ">
                                                                <a href="reset_pass.php" type="submit" name="reset" class="btn  btn-danger " style="font-size: medium;"> Reset Password </a>
