                                ...
                                <div class="modal-body">
                                    <form class="user" method="POST" action="proses_tambahCV.php" enctype="multipart/form-data">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-lg-6">
                                                <input type="number" class="form-control form-control-user" name="nohp" placeholder="Ketik Nomor Handphone..." required>
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <select class="custom-select" style="height: 50px;  border-radius: 30px;" name="jurusan" required>
                                            ...
                                            <div class="form-group col-lg-6">
                                                <input type="number" class="form-control form-control-user" name="angkatan" placeholder="Ketik Tahun Angkatan ..." required>
                                            </div>
                                            <div class="form-group col-lg-6">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="font-size: 14px"><?php $jurusan = $d['jurusan'];
                                                                        if ($jurusan == "AB") {
                                                                            echo $status_M = "Administrasi Bisnis";
                                                                        } else if ($jurusan == "TK") {
                                                                            echo $status_M = "Teknologi Komputer";
                                                                        } else {
                                                                            echo $status_M = "Akutansi";
                                                                        } ?></td>
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="user" method="POST" action="proses_editCV.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-row">
                                                                        ...
                                                                        <div class="form-group col-lg-6">
                                                                            <input type="number" class="form-control form-control-user" name="nohp" placeholder="Ketik Nomor Handphone..." value="<?php echo $d['no_hp']; ?>" required>
                                                                        </div>
                                                                        <div class="form-group col-lg-6">
                                                                            <select class="custom-select" style="height: 50px;  border-radius: 30px;" name="jurusan" required>
                                                                                <?php
                                                                        ...
                                                                        <div class="form-group col-lg-6">
                                                                            <input type="number" class="form-control form-control-user" name="angkatan" placeholder="Ketik Tahun Angkatan ..." value="<?php echo $d['tahun_angkatan']; ?>" required>
                                                                        </div>

                                                                        <div class="form-group col-lg-6">
                                                                            <input type="file" id="gambar" name="gambar" style="display:none" onchange="document.getElementById('filename').value=this.value">
                                                                            <input type="text" class="form-control form-control-user" id="filename" value="<?php echo $d['gambar']; ?>" readonly>
